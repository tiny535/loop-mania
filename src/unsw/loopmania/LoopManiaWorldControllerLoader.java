...
public class LoopManiaWorldControllerLoader extends LoopManiaWorldLoader {
    ...
    public LoopManiaWorldControllerLoader(String filename)
        ...
        characterImage = new Image((new File("src/images/hero.png")).toURI().toString());
    ...
    @Override
    public void onLoad(HeroCastleBuilding castle) {
        ImageView view = new ImageView((new File("src/images/"+ castle.getImageSrc() +".png")).toURI().toString());
     ...
     * We only setup the node to follow the coordinates of the backend entity.
